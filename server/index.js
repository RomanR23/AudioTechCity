...
const { getProducts, getCartItems, inputProduct, updateExistingProduct, updateExistingProductCheckout, deleteProductCheckout, clearCheckout } = require('./controllers/products')
